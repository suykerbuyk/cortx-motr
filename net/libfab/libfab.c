				...
				struct m0_fab__ep_name *epname)
{
	...
	*rma_key = ((struct fi_rma_iov *)ptr)->key;
}
...
static m0_bcount_t libfab_get_max_buf_desc_size(const struct m0_net_domain *dom)
{
	...
	return (sizeof(struct fi_rma_iov) /* FAB_MR_IOV_MAX*/);
}
